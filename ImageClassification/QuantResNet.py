...
def convert_model(modelName,dataset,train_loader, test_loader):
...
if __name__ == '__main__':
    ...
    quantized_model=convert_model(modelName=modelName,dataset=dataset,train_loader=train_loader,test_loader=test_loader)
    # 4. 评估 INT8 量化模型的准确率
